...
struct MmiddLexerStaticData final {
  MmiddLexerStaticData(std::vector<std::string> ruleNames,
  ...
  MmiddLexerStaticData(const MmiddLexerStaticData&) = delete;
  MmiddLexerStaticData(MmiddLexerStaticData&&) = delete;
  MmiddLexerStaticData& operator=(const MmiddLexerStaticData&) = delete;
  MmiddLexerStaticData& operator=(MmiddLexerStaticData&&) = delete;
...
std::once_flag mmiddlexerLexerOnceFlag;
MmiddLexerStaticData *mmiddlexerLexerStaticData = nullptr;

void mmiddlexerLexerInitialize() {
  assert(mmiddlexerLexerStaticData == nullptr);
  auto staticData = std::make_unique<MmiddLexerStaticData>(
  ...
  mmiddlexerLexerStaticData = staticData.release();
}

}

mmiddLexer::mmiddLexer(CharStream *input) : Lexer(input) {
  mmiddLexer::initialize();
  _interpreter = new atn::LexerATNSimulator(this, *mmiddlexerLexerStaticData->atn, mmiddlexerLexerStaticData->decisionToDFA, mmiddlexerLexerStaticData->sharedContextCache);
}

mmiddLexer::~mmiddLexer() {
  delete _interpreter;
}

std::string mmiddLexer::getGrammarFileName() const {
  return "test1.g4";
}

const std::vector<std::string>& mmiddLexer::getRuleNames() const {
  return mmiddlexerLexerStaticData->ruleNames;
}

const std::vector<std::string>& mmiddLexer::getChannelNames() const {
  return mmiddlexerLexerStaticData->channelNames;
}

const std::vector<std::string>& mmiddLexer::getModeNames() const {
  return mmiddlexerLexerStaticData->modeNames;
}

const dfa::Vocabulary& mmiddLexer::getVocabulary() const {
  return mmiddlexerLexerStaticData->vocabulary;
}

antlr4::atn::SerializedATNView mmiddLexer::getSerializedATN() const {
  return mmiddlexerLexerStaticData->serializedATN;
}

const atn::ATN& mmiddLexer::getATN() const {
  return *mmiddlexerLexerStaticData->atn;
}




void mmiddLexer::initialize() {
  std::call_once(mmiddlexerLexerOnceFlag, mmiddlexerLexerInitialize);
}
